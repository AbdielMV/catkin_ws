function [data, info] = joyTurboAction
%JoyTurboAction gives an empty data for twist_mux_msgs/JoyTurboAction
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'twist_mux_msgs/JoyTurboAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.custommessages.twist_mux_msgs.joyTurboActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.custommessages.twist_mux_msgs.joyTurboActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.custommessages.twist_mux_msgs.joyTurboActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'twist_mux_msgs/JoyTurboAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
