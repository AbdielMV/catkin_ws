...
struct WholeBodyState_
{
  ...
  _centroidal_type centroidal;
   ...
   typedef std::vector< ::whole_body_state_msgs::JointState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::whole_body_state_msgs::JointState_<ContainerAllocator> >::other >  _joints_type;
  _joints_type joints;

   typedef std::vector< ::whole_body_state_msgs::ContactState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::whole_body_state_msgs::ContactState_<ContainerAllocator> >::other >  _contacts_type;
  _contacts_type contacts;

   typedef std::vector< ::whole_body_state_msgs::RhonnState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::whole_body_state_msgs::RhonnState_<ContainerAllocator> >::other >  _rhonn_type;
  _rhonn_type rhonn;
...
struct MD5Sum< ::whole_body_state_msgs::WholeBodyState_<ContainerAllocator> >
{
  ...
  {
    return "9032df000e60db70b7016248d5ff14b8";
  }

  static const char* value(const ::whole_body_state_msgs::WholeBodyState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9032df000e60db70ULL;
  static const uint64_t static_value2 = 0xb7016248d5ff14b8ULL;
};
...
struct Printer< ::whole_body_state_msgs::WholeBodyState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::whole_body_state_msgs::WholeBodyState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "rhonn[]" << std::endl;
    for (size_t i = 0; i < v.rhonn.size(); ++i)
    {
      s << indent << "  rhonn[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::whole_body_state_msgs::RhonnState_<ContainerAllocator> >::stream(s, indent + "    ", v.rhonn[i]);
    }
  }
};
