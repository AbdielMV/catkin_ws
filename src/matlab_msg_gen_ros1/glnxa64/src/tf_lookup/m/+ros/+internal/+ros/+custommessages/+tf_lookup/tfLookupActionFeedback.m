function [data, info] = tfLookupActionFeedback
%TfLookupActionFeedback gives an empty data for tf_lookup/TfLookupActionFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'tf_lookup/TfLookupActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.custommessages.tf_lookup.tfLookupFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'tf_lookup/TfLookupActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
