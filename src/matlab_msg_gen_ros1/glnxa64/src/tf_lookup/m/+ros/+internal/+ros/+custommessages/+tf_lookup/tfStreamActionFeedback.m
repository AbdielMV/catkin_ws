function [data, info] = tfStreamActionFeedback
%TfStreamActionFeedback gives an empty data for tf_lookup/TfStreamActionFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'tf_lookup/TfStreamActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.custommessages.tf_lookup.tfStreamFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'tf_lookup/TfStreamActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
