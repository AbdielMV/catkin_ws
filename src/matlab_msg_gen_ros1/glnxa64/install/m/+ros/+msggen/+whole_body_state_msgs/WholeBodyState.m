...
classdef WholeBodyState < ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '9032df000e60db70b7016248d5ff14b8' % The MD5 Checksum of the message definition
        ...
        PropertyMessageTypes = { 'ros.msggen.std_msgs.Header' ...
            ...
            'ros.msggen.whole_body_state_msgs.RhonnState' ...
            '' ...
    ...
    methods
        ...
        function set.Rhonn(obj, val)
            if isempty(val)
                % Allow empty [] input
                val = ros.msggen.whole_body_state_msgs.RhonnState.empty(0, 1);
            end
            val = val(:);
            validAttributes = {'vector'};
            validClasses = {'ros.msggen.whole_body_state_msgs.RhonnState'};
