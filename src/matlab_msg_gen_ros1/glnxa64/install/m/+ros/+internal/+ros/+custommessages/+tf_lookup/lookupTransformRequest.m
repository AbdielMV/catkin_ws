function [data, info] = lookupTransformRequest
%lookupTransform gives an empty data for tf_lookup/lookupTransformRequest
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'tf_lookup/lookupTransformRequest';
...
info.MessageType = 'tf_lookup/lookupTransformRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
