function [data, info] = joyTurboActionResult
%JoyTurboActionResult gives an empty data for twist_mux_msgs/JoyTurboActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'twist_mux_msgs/JoyTurboActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.twist_mux_msgs.joyTurboResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'twist_mux_msgs/JoyTurboActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
