function [data, info] = joyTurboActionFeedback
%JoyTurboActionFeedback gives an empty data for twist_mux_msgs/JoyTurboActionFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'twist_mux_msgs/JoyTurboActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.custommessages.twist_mux_msgs.joyTurboFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'twist_mux_msgs/JoyTurboActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
