function [data, info] = joyPriorityActionResult
%JoyPriorityActionResult gives an empty data for twist_mux_msgs/JoyPriorityActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'twist_mux_msgs/JoyPriorityActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.twist_mux_msgs.joyPriorityResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'twist_mux_msgs/JoyPriorityActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
