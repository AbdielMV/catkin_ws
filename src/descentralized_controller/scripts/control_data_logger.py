...
class DataLogger:
    def __init__(self):
        ...
        # Parameters
        self.output_file = rospy.get_param("~output_file", "control_states.csv")
        self.topic_name = rospy.get_param("~topic_name", "/reemc/efforts")

        # Open CSV file and write headers
        self.csv_file = open(self.output_file, 'w')
        self.csv_writer = csv.writer(self.csv_file)
        self.csv_writer.writerow(['Time', 'Name', 'Z0', 'Z1', 'Reference'])
    ...
    def callback(self, data):
        ...
        for rhonn in data.rhonn:
            ...
            # Write to CSV
            self.csv_writer.writerow([time_now, name, z0_value, z1_value, ref])
