function [data, info] = tfLookupResult
%TfLookupResult gives an empty data for tf_lookup/TfLookupResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'tf_lookup/TfLookupResult';
[data.Transform, info.Transform] = ros.internal.ros.messages.geometry_msgs.transformStamped;
info.Transform.MLdataType = 'struct';
info.MessageType = 'tf_lookup/TfLookupResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
