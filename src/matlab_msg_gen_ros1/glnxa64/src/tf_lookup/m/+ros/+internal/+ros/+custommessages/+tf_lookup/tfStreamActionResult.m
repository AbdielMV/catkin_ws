function [data, info] = tfStreamActionResult
%TfStreamActionResult gives an empty data for tf_lookup/TfStreamActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'tf_lookup/TfStreamActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.tf_lookup.tfStreamResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'tf_lookup/TfStreamActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.subscription_id';
info.MatPath{27} = 'result.topic';
